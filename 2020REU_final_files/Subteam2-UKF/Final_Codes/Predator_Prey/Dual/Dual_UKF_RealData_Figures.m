...
p2 = plot(1845:1935, paramshat_real(1,:), 'b', 'Linewidth', 2); hold off;
...
p2 = plot(1845:1935, paramshat_real(2,:), 'b', 'Linewidth', 2); hold off;
...
p2 = plot(1845:1935, paramshat_real(3,:), 'b', 'Linewidth', 2); hold off;
...
p2 = plot(1845:1935, paramshat_real(4,:), 'b', 'Linewidth', 2); hold off;
