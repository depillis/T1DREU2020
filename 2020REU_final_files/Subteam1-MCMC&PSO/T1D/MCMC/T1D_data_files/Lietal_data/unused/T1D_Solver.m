...
[Tnowave, Ynowave] = ode15s(@(t,y)T1D_ODE(t,y,f1,f2,wave),Tspan,IC); % Solve ODE

%Solve ODE for NOD
[Tnnowave, Ynnowave] = ode15s(@(t,y)T1D_ODE(t,y,f1n,f2n,wave),Tspan,IC); % Solve ODE
...
%Solve ODE for wild type
[Twave, Ywave] = ode15s(@(t,y)T1D_ODE(t,y,f1,f2,wave),Tspan,IC); % Solve ODE

%Solve ODE for NOD

options=odeset('Events',@sickEvents);
 [Tnwave, Ynwave,Te,Ye,ie] =...
     ode15s(@(t,y)T1D_ODE(t,y,f1n,f2n,wave),Tspan,IC,options); % Solve ODE
