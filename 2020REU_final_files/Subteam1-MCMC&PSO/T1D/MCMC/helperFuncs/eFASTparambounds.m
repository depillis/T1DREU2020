%% Create upper and lower bounds for DRAM
%  Author:       C. Catlett
%  Date:         June 18, 2020
...
function [lb, ub, orig] = eFASTparambounds(table, percent)
D_ss         = table.D_ss;
EG0          = table.EG0;
GI           = table.GI;
Ghb          = table.Ghb;
...
lb = [D_ss(2), EG0(2), GI(2), Ghb(2), J(2), Qblood(2), Qpanc(2), Qspleen(2), ...
    ...
    ramday(2), sE(2), sR(2), scale_factor(2), sigmaI(2), thetaD(2)];
...
ub = [D_ss(3), EG0(3), GI(3), Ghb(3), J(3), Qblood(3), Qpanc(3), Qspleen(3), ...
    ...
    ramday(3), sE(3), sR(3), scale_factor(3), sigmaI(3), thetaD(3)];
...
orig = [D_ss(1), EG0(1), GI(1), Ghb(1), J(1), Qblood(1), Qpanc(1), Qspleen(1), ...
    ...
    ramday(1), sE(1), sR(1), scale_factor(1), sigmaI(1), thetaD(1)];
end
