...
proteins<-read.csv("noise data 0.1%.csv", sep="\t", dec=".")
...
#write.csv(x, file=x[]"set parameter solutions_egf path all points egf2.csv")
#write.csv(x, file=x[]"set parameter solutions_egf path all points.csv")
write.csv(data.matrix(parameters), file="set parameter solutions_egf path all points.csv")
#write.csv(x, file=x[]"set parameter solutions_egf path concentration.csv")
#write.csv(x, file=x[]"set parameter solutions_egf path concentration.intensity correction.csv")
