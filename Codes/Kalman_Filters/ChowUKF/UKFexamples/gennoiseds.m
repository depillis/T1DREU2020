...
% From http://www.cs.utah.edu/~tch/notes/matlab/ReBEL/code/ReBEL-0.2.5/core/gennoiseds.m
...
%            .likelihood : (finction handle) Function to evaluate the likelihood of a given noise source sample
...
case 'gaussian'
    ...
    %.............................................................................................
    otherwise
        error(' [ gennoiseds::gaussian ] Unkown noise source cov_type.');
    end
...
case 'combo-gaussian'
    ...
    for k=1:Noise.N
        ...
        if ~stringmatch(subNoise.cov_type,cov_type)
            error('[ gennoiseds::combo-gaussian ] Sub noise sources does not have consistentent cov_types.');
        end
    end
    ...
    if (Noise.dim ~= dim),
        error([' [ gennoiseds::combo-gaussian ] Combinded noise vector dimension does ' ...
               'not agree with agregate dimension of sub noise sources.']);
    end
