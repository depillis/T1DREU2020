function dydt = AlbersODEwParams(t,y)
% LdeP Update to allow for 3 additional parameters appended to the end April 2, 2020
% Author: LDP and CLe
...
I_p = y(1); I_i = y(2); G = y(3); h_1 = y(4); h_2 = y(5); h_3 = y(6);
% LdeP Append Params April 2020 (will overwrite anything read in from AlbersParamVals)
E = y(7);
V_i = y(8);
t_i = y(9);
...
% LdeP April 2, 2020 Append ODEs which treat the params as constant
dE = 0;
dVi = 0;
dti = 0;
...
dydt = [dI_p; dI_i; dG; dh_1; dh_2; dh_3; dE; dVi; dti];
