...
% This won't run with current parameters beyond 785 time steps, even when
% trying to use the same process and measurement noise as in SR-UKF.
timeFinal=785; %LdeP figure out sigma point issue 785 final time won't throw a sigma point error
...
%%%%%% LdeP Trying same params as the SR-UKF code
%%%%%% R = 2.25; sqrtR = sqrt(R);
...
%%%%%% LdeP Trying same params as the SR-UKF code
%%%%%%% ukf.ProcessNoise = 0.1*eye(NumberOfStates);
